...
simu_barcode_random_uniform(
    ...
    output = "./tmp/random_barcodes_uniform.tsv" ## the output file
)
...
simu_barcode_random_norm(
    ...
    output = "./tmp/random_barcodes_norm.tsv" ## the output file
)
...
simu_barcode_random_lnorm(
    ...
    output = "./tmp/random_barcodes_lnorm.tsv" ## the output file
)
...
simu_barcode_random_exp(
    ...
    output = "./tmp/random_barcodes_exp.tsv" ## the output file
)
...
simu_barcode_hamming_uniform(
    ...
    output = "./tmp/hamming_barcodes_uniform.tsv" ## the output file
)
